class Renderer {
    ...
    <div data-id="${coinData.id}" id="${coinData.id
        ...
        <div class="card-body main-card">
            ...
            <div class="custom-control custom-switch">
                <input type="checkbox" class="custom-control-input " id="customSwitch${coinData.id
            }" ${checked}>
                <label class="custom-control-label" for="customSwitch${coinData.id
            }">Select Coin</label>
            </div>
            ...
            <div class="modal-card" data-id="${selectedCoinData.id}">
                <div class="modal-card-body">
                    ...
                    <div class="modal-custom-control modal-custom-switch">
                        <input type="checkbox" class="modal-custom-control-input " id="customSwitch2${selectedCoinData.id
            }" checked>
                        <label class="modal-custom-control-label" for="customSwitch2${selectedCoinData.id
            }">Select Coin</label>
                    </div>
                </div>
            </div>
